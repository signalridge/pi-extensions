...
describe("issue #142: RPC handlers + subagents:ready are gated on session_start", () => {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<PropertyKey, unknown>)[Symbol.for("pi-subagents:manager-active")];
    delete (globalThis as Record<PropertyKey, unknown>)[Symbol.for("pi-subagents:rpc-owner")];
  });
