...
This document explains the security model behind `@signalridge/pi-subagents` and
...
[GitHub Security Advisories](https://github.com/signalridge/pi-extensions/security/advisories/new)
for this repository.
