...
export default defineConfig({
  ...
  test: {
    // The scheduler E2E deliberately exercises real timers. Keep this package's
    // 52-file suite bounded to one file at a time so provider/session fixtures
    // cannot starve a 100ms timer under the repository-wide check.
