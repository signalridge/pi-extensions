...
// `classic` is the Signalridge text-first profile. The other named presets
// retain the optional powerline renderer for users who explicitly choose it.
export const PALETTE_PRESET_NAMES = ["classic", ...PALETTE_NAMES, "custom"] as const;
