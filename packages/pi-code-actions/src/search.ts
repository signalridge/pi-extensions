...
import { getSnippetPreview } from "./snippets.js";
...
export function buildSearchIndex(snippets: Snippet[], items: SelectItem[]): SearchIndexItem[] {
  return snippets.flatMap((snippet, idx) => {
...
export function rankedFilterItems(filter: string, items: SelectItem[], searchIndex: SearchIndexItem[]): SelectItem[] {
